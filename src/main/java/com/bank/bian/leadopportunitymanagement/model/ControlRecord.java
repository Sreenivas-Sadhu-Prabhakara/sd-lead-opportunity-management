package com.bank.bian.leadopportunitymanagement.model;
...
/**
 * The BIAN control record for this service domain: "Sales Lead Management Plan".
 *
 ...
 * to its asset type (Sales Lead). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Sales Lead Management Plan";
